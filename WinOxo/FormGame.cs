...
namespace WinOxo
{
    ...
    public partial class FormGame : Form
    {
        ...
        private void buttonScores_Click(object sender, EventArgs e)
        {
            ...
            buttonPlayer1.ForeColor = Color.FloralWhite;
            buttonPlayer2.Font = new Font(buttonPlayer2font, FontStyle.Bold);
            buttonPlayer2.ForeColor = Color.FloralWhite;
        ...
        private void OnPlayerChanged(int currentPlayer)
        {
            if (currentPlayer == 1)
            {
                ...
                buttonPlayer2.ForeColor = Color.RoyalBlue;
            }
            ...
            if (currentPlayer == 2)
            {
                ...
                buttonPlayer1.ForeColor = Color.RoyalBlue;
            }
        }
